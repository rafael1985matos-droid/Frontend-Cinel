...
export const routes: Routes = [
  {
    path: '',
    redirectTo: 'ebook/welcome',
    pathMatch: 'full',
  },
  {
    path: 'ebook/welcome',
    loadComponent: () => import('./pages/welcome/welcome').then((rafael) => rafael.Welcome),
  },
  {
    path: 'ebook/lacos',
    component: Lacos,
